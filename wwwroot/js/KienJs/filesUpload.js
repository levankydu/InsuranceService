...
function FilesUpload({
    ...
    if (!document.querySelector(filesUpload)) {
        return false;
    }

    const addBtn = document.querySelector(addBtnSelector);
    let inputOrigin = document.querySelector(inputSelector);
    const listImages = document.querySelector(listImagesSelector);
    const inputContainer = document.querySelector(inputContSelector);
    ...
    function addImages(e) {
        ...
        if (multiple) {
            ...
            inputOrigin = document.querySelector(inputSelector);
            inputOrigin.addEventListener("change", addImages);
        } else {
