...
namespace test0000001.Clients
{
    public sealed class PaypalForLifeClient
    {
        ...
        public PaypalForLifeClient(string clientId, string clientSecret, string mode)
        {
            ClientId = clientId;
        ...
        private async Task<AuthResponse> Authenticate()
        {
            ...
            return response ?? throw new Exception("Cannot get Authorization");
        }
        ...
        public async Task<CreateOrderResponse> CreateOrder(string value, string currency, string reference)
        {
            ...
            return response ?? throw new Exception("Cannot get Order response");
        }
        ...
        public async Task<CaptureOrderResponse> CaptureOrder(string orderId)
        {
            ...
            return response ?? throw new Exception("Cannot get CaptureOrder response");
        }
    }
...
// https://github.com/juldhais/PaypalCheckoutExample?source=post_page-----90cb22cd465d--------------------------------